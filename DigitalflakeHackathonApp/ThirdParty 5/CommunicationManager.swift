...
/*import Foundation
 // uncomment this
import SwiftyJSON  // uncomment this
...
class CommunicationManager : NSObject {
            ...
            case .success( let upload,_,_):
                upload.responseJSON {
                    ...
                    if response.result.value != nil {
                        ...
                        let json = JSON(response.result.value!)
                        print(json)
                        if json.dictionaryValue["status"] == "1" || json.dictionaryValue["status"] == true || json.dictionaryValue["status"] == 1 || json.dictionaryValue["status"] == "SUCCESS" {
                            completion("success", json.dictionaryObject as AnyObject)
                        } else if json.dictionaryValue["status"] == "0" || json.dictionaryValue["status"] == false || json.dictionaryValue["status"] == 0 || json.dictionaryValue["status"] == "FAILURE"   {
    ...
    class func callRShrinkPostServiceFormData (_ urlString: String, param : [String: AnyObject]?,  completion: @escaping (_ result: String, _ data : AnyObject) -> Void) {
    ...
    class func callPMCertyPostServiceFormData (_ urlString: String, param : [String: AnyObject]?,  completion: @escaping (_ result: String, _ data : AnyObject) -> Void) {
            ...
            case .success( let upload,_,_):
                upload.responseJSON {
                    ...
                    if response.result.value != nil {
                        ...
                        let json = JSON(response.result.value!)
                        //print(json)
                        if json.dictionaryValue["is_success"] == "1" || json.dictionaryValue["is_success"] == true || json.dictionaryValue["is_success"] == 1 || json.dictionaryValue["is_success"] == "SUCCESS" {
                            completion("success", json.dictionaryObject as AnyObject)
                        } else if json.dictionaryValue["is_success"] == "0" || json.dictionaryValue["is_success"] == false || json.dictionaryValue["is_success"] == 0 || json.dictionaryValue["is_success"] == "FAILURE"   {
                            completion("failure", json.dictionaryObject as AnyObject)
                        } else {
                            completion("othercase", json.dictionaryObject as AnyObject)
                        }
